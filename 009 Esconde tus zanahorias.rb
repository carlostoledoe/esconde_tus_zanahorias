#jugarlo idealmente a pantalla completa
#objetivo del juego:
#Atrapar a los conejos (la cpu) antes que ellos atrapen tus zanahorias. Cada uno tiene 2 vidas (2 conjenos y 2 zanahoras).
